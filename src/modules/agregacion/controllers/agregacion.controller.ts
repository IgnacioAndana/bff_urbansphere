...
export class AgregacionControlador {
  ...
  @ApiOperation({
    summary: 'Proyecto con imágenes, tipologías (con imágenes) y equipamiento (público)',
    description:
      'Sin JWT: solo proyectos activos. Con JWT admin/agent incluye cualquier estado. 404 si el proyecto no existe o no está disponible.',
  })
